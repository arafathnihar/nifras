...
class plgHikashoppaymentpayfast extends hikashopPaymentPlugin
{
	...
	function onAfterOrderConfirm(&$order, &$methods, $method_id)
	{
		...
		{
			$this->app->enqueueMessage('You have to configure an merchant id for the payfast plugin payment first : check your plugin\'s parameters,
		...
		{
			$this->app->enqueueMessage('You have to configure the merchant key for the payfast plugin payment first : check your plugin\'s parameters,
			on your website backend','error');
		...
		{
			$this->writeToLog("Data send to PayFast: \n\n\n");
