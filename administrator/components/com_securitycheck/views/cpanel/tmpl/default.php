	...
	<div class="row-fluid">
		...
		<div class="box span3">
			...
			<div class="box-content">
				...
				<div class="center">
					<img src="/media/com_securitycheck/images/malwarescan.png" alt="New Securitycheck Pro feature: Malware scan" height="48" width="48">
				</div>				 
				<h3 align="center" style="color: #FF4500;"><?php echo JText::_('COM_SECURITYCHECK_FREE_VERSION_LINE11') ?></h3>
				<h5 align="center"><?php echo JText::_('COM_SECURITYCHECK_FREE_VERSION_LINE12') ?></h5>
				<hr>
