					...
					<div class="span6">
						<fieldset>
							...
							<div class="control-group">
								...
								<div class="controls">
									<select name="slDevive" id="slDevive">
										<option value="jsn_mobile" id="jsn_mobile"><?php echo JText::_( 'JSN_MOBILIZE_TITLE_SMARTPHONE' ); ?></option>
										<option value="jsn_tablet" id="jsn_tablet"><?php echo JText::_( 'JSN_MOBILIZE_TITLE_TABLET' ); ?></option>
									</select>
								</div>
							</div>
							<div class="control-group">
									...
									<div id="os-support" class="jsn-items-list-container">
										<div class="jsn-items-list ui-sortable">
											...
											foreach ( $this->_os as $os ) {
												$check = "";
												if ( in_array( $os->os_id, $this->_osSupport )) {
													$check = 'checked="true"';
												}
												?>
