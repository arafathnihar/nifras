...
class JFormFieldCustomCartParams extends JFormField
{
	...
	function getInput()
	{
		...
		$html[] = '<button class="btn btn-primary" data-rqc-addblock>Add New</button><div class="clr"></div>' . '<div id="div-' . $name . '" class="div-customfields">';
		...
		if (!empty($this->value)){
			foreach ($this->value as $key => $value) {
				...
				$html[] = '			<input type="text" name="'. $this->name . '[' . $key . ']" placeholder="ie, Colors, Sizes" value="'.$key.'" />';
